...
public class alipay {
    public static void main(String[] args) throws AlipayApiException {
        ...
        if (response.isSuccess()) {
            String urlStr = response.getBillDownloadUrl().replaceAll("http://dwbillcenter.alipaydev.com","http://10.10.10.102:8092");
            //指定希望保存的文件路径
